...
import ru.vsu.cs.course1.graph.Way;
...
public class GraphDemoFrame extends JFrame {
    ...
    public GraphDemoFrame() {
        ...
        JTableUtils.writeArrayToJTable(tableInput, new int[]{0, 8});

        JTableUtils.initJTableForArray(tableInput1, 40, false, false, false, true);
        tableInput1.setRowHeight(25);
        JTableUtils.writeArrayToJTable(tableInput1, new int[]{1, 2});

        JTableUtils.initJTableForArray(tableOut, 40, false, false, false, false);
        tableOut.setRowHeight(25);
        ...
        buttonCreateGraph.addActionListener(e -> {
            try {
                Class clz = Class.forName("ru.vsu.cs.course1.graph.AdjMatrixDigraph");
                Graph graph = GraphUtils.fromStr(textAreaGraphFile.getText(), Class.forName("ru.vsu.cs.course1.graph.AdjMatrixDigraph"));
        ...
        buttonDfsQueue.addActionListener(e -> {
            try {
                if (graph == null) {
                    SwingUtils.showInfoMessageBox("граф не построен");
                    return;
                }
                int[] arr = JTableUtils.readIntArrayFromJTable(tableInput);
                int[] arrExceptions = JTableUtils.readIntArrayFromJTable(tableInput1);
                int from = arr[0];
                int before = arr[1];

                Way last = GraphAlgorithms.bfs(graph, arrExceptions, from, before);

                if (last == null) {
                    SwingUtils.showInfoMessageBox("такого пути нет!");
                    return;
                }
                ...
                while (last != null) {
                    ...
                    ListNew.add(last.point());
                    last = last.past();

                }

                int[] Out = new int[ListNew.size()];
                for (int i = 0; i < ListNew.size(); i++) {
                    Out[i] = ListNew.get(ListNew.size() - i - 1);
                }

                JTableUtils.writeArrayToJTable(tableOut, Out);
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        panelMain.add(splitPaneGraphTab2, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        ...
        panel1.add(scrollPane1, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW, null, new Dimension(-1, 200), null, 0, false));
        textAreaGraphFile = new JTextArea();
        textAreaGraphFile.setText("9\n10\n0 5\n4 3\n0 1\n6 4\n5 4\n0 2\n0 6\n7 8\n5 3\n3 8");
        ...
        buttonDfsQueue.setText("поиск дороги");
        panel1.add(buttonDfsQueue, new GridConstraints(7, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        label1.setText("вершины начала и конца");
        ...
        label2.setText("вершины (поиск по ширине):");
        ...
        panel1.add(scrollPane2, new GridConstraints(9, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW, null, new Dimension(-1, 20), null, 0, false));
        tableOut = new JTable();
        scrollPane2.setViewportView(tableOut);
        final JScrollPane scrollPane3 = new JScrollPane();
        panel1.add(scrollPane3, new GridConstraints(4, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW, null, new Dimension(-1, 20), null, 0, false));
        tableInput = new JTable();
        scrollPane3.setViewportView(tableInput);
        final JScrollPane scrollPane4 = new JScrollPane();
        panel1.add(scrollPane4, new GridConstraints(6, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW, null, new Dimension(-1, 50), null, 0, false));
        tableInput1 = new JTable();
        scrollPane4.setViewportView(tableInput1);
        final JLabel label3 = new JLabel();
        label3.setText("исключенные вершины");
